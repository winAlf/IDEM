   ...
   <section class="content">
     ...
     <div class="box">
       <div class="box-header with-border">
         <h3 class="box-title">Formulario de edición de servicio</h3>
       </div>
       <div class="box-body">
         <div class="col-md-8">
           <form role="form" name="subirArchivo" id="subirArchivo" method="post" action="ajax.php" enctype="multipart/form-data">
             <div class="box-body">
               ...
               <div class="form-group">
                    ...
                    <select name="categoria" id="categoria" class="form-control">
                      <?php  while ($categoria = $categorias->fetch_assoc()) { ?>
                          <?php if ($categoria['idServCat'] == $id_cat): ?>
                              <option selected value="<?php echo $categoria['idServCat']; ?>"><?php echo $categoria['servCategoria']; ?></option>
                          <?php else: ?>
               ...
               <div class="form-group">
                 ...
                 <input type="text" name="subcategoria" class="form-control" id="subcategoria" value="<?php echo $row['servicio']; ?>" placeholder="Captura el nombre de la subcategoría">
               </div>
               <div class="form-group">
                 <label for="usuario">Descripción:</label>
                 <input type="text" name="descripcion" class="form-control" id="descripcion" value="<?php echo $row['servDesc']; ?>" placeholder="Captura la descripción de la subcategoria">
               </div>
               <div class="form-group">
                 <label for="nombre">Ordenamiento:</label>
                 <input type="text" name="ordenamiento" class="form-control" id="ordenamiento" value="<?php echo $row['servOrden']; ?>" placeholder="">
               </div>
               <div class="form-group">
                 <label for="nombre">Ícono:</label>
                 <input type="text" name="icono" class="form-control" id="icono" value="<?php echo $row['servIco']; ?>">
               </div>
               <div class="form-group">
                 <label for="nombre">Estará activo?</label>
                    <div class="radio">
                      <label>
