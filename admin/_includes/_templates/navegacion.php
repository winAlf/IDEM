...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    -->
        ...
        <a href="#">
          ...
          <span class="pull-right-container">
            <?php
                ...
                $sqlVp = "SELECT COUNT(*) totalV FROM ventasdb WHERE visto = '0'";
                $Cantv = $conn->query($sqlVp);
                $numeroVp = $Cantv->fetch_assoc();
                //echo 'Número de total de registros: ' . $numeroV['total'];

             ?>
             <span class="label label-warning pull-right"><?php echo $numeroVp['totalV']; ?></span>
            <span class="label label-primary pull-right"><?php echo $numeroV['total']; ?></span>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="/admin/contacto/index.php?n=1"><i class="fas fa-user"></i> Nuevos Contactos<span class="label label-primary pull-right"><?php echo $numeroV['total']; ?></span></a></li>
          <li><a href="/admin/contacto"><i class="fas fa-user"></i> Contactos</a></li>
          <li><a href="/admin/ventas/index.php?n=1"><i class="fas fa-user"></i> Nuevas Ventas<span class="label label-warning pull-right"><?php echo $numeroVp['totalV']; ?></span></a></li>
          <li><a href="/admin/ventas"><i class="fas fa-user"></i> Ventas</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fas fa-pencil-ruler"></i> <span>Diseño</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="/admin/banner/"><i class="fas fa-flag-checkered"></i> Banner</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
